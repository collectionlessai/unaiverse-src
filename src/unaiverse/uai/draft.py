...
from .serialize import serialize_block, num_to_text
from .coerce import check_canonical
from .constants import PROTOCOL_VERSION, MAX_ALT_CHARS
...
def encode_reply(spec: dict, values: dict) -> str:
    ...
    marker, so that every implementation produces the same bytes.
